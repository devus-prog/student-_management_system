...
The program allows users to add student details, display all records, and generate a rank list based on total marks.
...
- Generate rank list based on highest total marks
